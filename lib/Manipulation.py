...
class DepthRay(ManipulationTechnique):
    ...
    def evaluate(self): # implement respective base-class function
        ...
        #angle = self.get_roll_angle(self.pointer_node.Transform.value)
        ...
        #print("Pitch: ", pitch)
        #print("Yaw  : ", angle)
        #angle2 = self.get_roll_angle(self.pointer_node.Transform.value * avango.gua.make_rot_mat(-90, 0.0, 0.0, 1.0))
        #print("angle: ", angle2)
        if abs(angle) >= 15.0:
            angle *= 0.00001
